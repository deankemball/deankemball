...
function AboutHero() {
  return (
    <div className="font-inter text-xl md:text-2xl lg:text-3xl flex flex-col mx-auto select-none w-full max-w-[19rem] md:max-w-[23rem] lg:max-w-[840px] leading-6 md:leading-7 lg:items-center lg:-translate-x-10 lg:gap-8 z-50 justify-center my-auto items-center h-fit relative scrollbar-hide">
  <div className="mx-auto absolute top-0 bottom-0 my-auto h-full max-h-[calc(100vw-64px)] w-full max-w-[calc(100vw-64px)] md:max-h-[448px] md:max-w-[448px] aspect-square flex justify-around flex-col z-20 overflow-hidden">
