...
const MarqueeItem = ({item, direction}: {item: string, direction: string}) => {
  return (
    <Marquee  speed={20} direction={direction as 'left' | 'right' | 'up' | 'down'} className='group'>
        <div className="flex gap-2 w-full whitespace-nowrap items-center text-2xl md:text-4xl px-2 group cursor-pointer">
